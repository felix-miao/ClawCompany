...
const AGENT_CONFIGS: AgentConfig[] = [
  { id: 'pm-agent', name: 'PM Agent', role: 'Project Manager', emoji: '📋', color: '#45b7d1', systemPrompt: '', runtime: 'subagent' },
  { id: 'dev-agent', name: 'Dev Agent', role: 'Developer', emoji: '👩‍💻', color: '#ff6b6b', systemPrompt: '', runtime: 'subagent' },
  { id: 'review-agent', name: 'Review Agent', role: 'Code Reviewer', emoji: '🔍', color: '#96ceb4', systemPrompt: '', runtime: 'subagent' },
  { id: 'test-agent', name: 'Test Agent', role: 'Tester', emoji: '🧪', color: '#4ecdc4', systemPrompt: '', runtime: 'subagent' },
];
